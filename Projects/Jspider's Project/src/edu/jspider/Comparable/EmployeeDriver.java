...
public class EmployeeDriver {
	...
	public static void main(String[] args) {
		...
		List<Employee> list2 = stream.filter(sal->sal.employeeSalary>80000).collect(Collectors.toList());
		list2.stream().map(bonus->bonus.employeeSalary+10000).forEach(x->System.out.println(x));
	}
}
